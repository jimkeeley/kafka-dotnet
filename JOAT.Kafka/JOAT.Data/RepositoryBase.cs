...
public class RepositoryBase : IDisposable
{
    ...
    protected async Task<int> ExecuteAsyncWithRetry(string sql, object param = null,
        IDbTransaction transaction = null, int? commandTimeout = null,
        CommandType? commandType = null) =>
        await RetryPolicy.ExecuteAsync(async () => await DbConnection.ExecuteAsync(sql, param, transaction, commandTimeout, commandType));

    protected async Task<int> ExecuteScalarAsyncWithRetry(string sql, object param = null,
        IDbTransaction transaction = null, int? commandTimeout = null,
        CommandType? commandType = null) =>
        await RetryPolicy.ExecuteAsync(async () => await DbConnection.ExecuteScalarAsync<int>(sql, param, transaction, commandTimeout, commandType));

    protected async Task<IEnumerable<T>> QueryAsyncWithRetry<T>(string sql, object param = null,
        IDbTransaction transaction = null, int? commandTimeout = null,
        CommandType? commandType = null) =>
        await RetryPolicy.ExecuteAsync(async () => await DbConnection.QueryAsync<T>(sql, param, transaction, commandTimeout, commandType));

    protected static bool ShouldRetryOn(SqlException ex)
    {
    ...
    protected static bool ShouldRetryOn(Win32Exception ex)
    {
